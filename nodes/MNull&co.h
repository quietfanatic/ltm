...
static inline void LTM_start_MNull (Match* m, MStr_t str) {
	DEBUGLOG(" ## Matching MNull\n");
	m->end = m->start;
	return;
}

static inline void LTM_start_MBegin (Match* m, MStr_t str) {
...
static inline void LTM_start_MEnd (Match* m, MStr_t str) {
